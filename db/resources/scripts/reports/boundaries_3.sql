...
CREATE OR REPLACE VIEW reports.boundaries_3 AS 
 SELECT level_0.name AS level_0, level_0.id AS level_0_id, level_1.name AS level_1, level_1.id AS level_1_id, level_2.name AS level_2, level_2.id AS level_2_id, level_3.name AS level_3, level_3.id AS level_3_id, sum(
        CASE
   ...
   LEFT JOIN boundaries level_3 ON locations.level_3 = level_3.id
  GROUP BY level_0.name, level_0.id, level_1.name, level_1.id, level_2.name, level_2.id, level_3.name, level_3.id
  ORDER BY level_0.name, level_1.name, level_2.name, level_3.name;