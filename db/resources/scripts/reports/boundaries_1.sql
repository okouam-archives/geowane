...
CREATE OR REPLACE VIEW reports.boundaries_1 AS 
 SELECT level_0.name AS level_0, level_0.id AS level_0_id, level_1.name AS level_1, level_1.id AS level_1_id, sum(
        CASE
  ...
  GROUP BY level_0.name, level_0.id, level_1.name, level_1.id
  ORDER BY level_0.name, level_1.name;