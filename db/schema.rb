...
ActiveRecord::Schema.define(:version => 20110131221520) do
  ...
  create_table "locations", :force => true do |t|
    ...
    t.string   "long_name"
    t.integer  "tags_count",                           :default => 0
    t.integer  "administrative_unit_0"
    t.integer  "administrative_unit_1"
    t.integer  "administrative_unit_2"
    t.integer  "administrative_unit_3"
    t.integer  "administrative_unit_4"
  end
