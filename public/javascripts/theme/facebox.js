...
(function($) {
  ...
  function fillFaceboxFromIframe(href, klass, height) {   
    $.facebox.reveal('<iframe onload="sizeFrame()" scrolling="no" class="autoHeight" marginwidth="0" width="500" height="' + height + '" frameborder="0" src="' + href + '" marginheight="0"></iframe>', klass)
  }
